...
//Serial.println(hour(ActualTime));
  
if(hour(ActualTime) >= 2 && hour(ActualTime) <= 12) //0200-1300 off  
{
    currentProgram = 10;
...
{
if(ActualTime - previousTime >= ChangeTime) //change the program 
{
   currentProgram++; //advance program
   previousTime = ActualTime; //store the new time
