...
const int NumLEDsPerUniverse = 170; //Number of LEDs per universe. No more than 170 per universe (3 channels per LED)
...
const int NUM_LEDS = 850; //total number of LEDs
...
unsigned long currentDelay = 0; //current time value for E1.31 reception
unsigned long previousTime = 0; //time variable
unsigned long ChangeTime = 600000; //10 minutes in milliseconds 

// buffers for receiving data
unsigned char DataBuffer[BUFFER_SIZE]; //buffer to hold incoming E1.31 
